...
app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://techplement-task-frontend.vercel.app','https://techplement-eta.vercel.app/api/auth/login','https://techplement-eta.vercel.app/api/auth/register'); // Set the exact origin
